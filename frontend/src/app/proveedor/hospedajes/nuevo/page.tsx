...
export default function NuevoHospedajePage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Nuevo Hospedaje" description="Registra un nuevo alojamiento" />
      <Card>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                <Label>Nombre *</Label>
                <Input {...register("nombre")} placeholder="Nombre del hospedaje" />
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <textarea {...register("descripcion")} className="input-base min-h-[100px] w-full" placeholder="Describe tu hospedaje..." />
              </div>
            </div>
            <div className="flex gap-3 pt-4">
              <Button type="submit">Crear Hospedaje</Button>
