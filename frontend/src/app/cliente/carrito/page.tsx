    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Explora nuestros hospedajes, actividades y más</p>
          <p className="mt-2 text-xs text-muted-foreground">Las reservas se realizan directamente desde cada servicio</p>
          <div className="mt-4 flex gap-3">
            <Link href="/hospedajes"><Button>Explorar Hospedajes</Button></Link>
